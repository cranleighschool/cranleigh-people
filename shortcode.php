	...
	class Cranleigh_People_Shortcode {
		...
		function table_list_row($atts, $content=null) {
			...
			if (count($posts)==1) {
				...
				return new WP_Error("Error getting User Data", "Could not locate data for the user: &quot;".$atts['username']."&quot;.");
			}
			$output = "";
					...
					<div class="card landscape light">
						<div class="row">
							...
							<div class="col-xs-8">
								...
								?>
									<h4><a class="hidden-xs" href="mailto:<?php echo $email; ?>"><span class="sr-only">E-mail:</span><span class="glyphicon glyphicon-envelope"></span></a> <a href="<?php echo get_permalink($post->ID); ?>"><?php echo $full_title; ?></a><span class="hidden-xs qualifications"><?php echo $qualifications; ?></span></h4>
