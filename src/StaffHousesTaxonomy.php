<?php
	...
	class StaffHousesTaxonomy
	{
		public CONST TAXONOMY_KEY = 'staff_houses';
		...
		public function init()
		{
			...
			$labels = [
				'name'                       => _x('Staff Houses', 'Taxonomy General Name', 'cranleigh-2016'),
				'singular_name'              => _x('Staff Role', 'Taxonomy Singular Name', 'cranleigh-2016'),
				'menu_name'                  => __('Staff Houses', 'cranleigh-2016'),
				'all_items'                  => __('All Staff Houses', 'cranleigh-2016'),
				...
				'add_or_remove_items'        => __('Add or remove staff Houses', 'cranleigh-2016'),
				'choose_from_most_used'      => __('Choose from the most used', 'cranleigh-2016'),
				'popular_items'              => __('Popular Houses', 'cranleigh-2016'),
				'search_items'               => __('Search Houses', 'cranleigh-2016'),
