 ...
 */
if (! class_exists('CranleighSchool\CranleighPeople\WeDevsSettingsAPI')) {
        ...
        public function admin_init()
        {
            ...
            foreach ($this->settings_fields as $section => $field) {
                foreach ($field as $option) {
                    ...
                    add_settings_field($section.'['.$option['name'].']', $option['label'], [$this, 'callback_'.$type], $section, $section, $args);
                }
            }
