...
class ArrayIndentationSniff extends Sniff
{
    ...
    public function process_token($stackPtr)
    {
        ...
        if ($closer_line_spaces !== $opener_line_spaces) {
            ...
            if (0 === $closer_line_spaces
                ...
                $this->phpcsFile->addError(
                    ...
                    $closer,
                    $error_code,
                    [$opener_line_spaces, $closer_line_spaces]
                );
            }
        ...
        foreach ($array_items as $item) {
            ...
            if (false !== $first_content
                ...
                $first_content = $this->phpcsFile->findNext(
                    [\T_WHITESPACE, \T_DOC_COMMENT_WHITESPACE, \T_COMMENT],
                    ($first_content + 1),
                    $end_of_this_item,
                    true
                );
    ...
    {
        $fix = $this->phpcsFile->addFixableError($error, $ptr, $error_code, [$expected, $found]);
        if (true === $fix) {
