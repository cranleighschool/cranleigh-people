...
class MultipleStatementAlignmentSniff extends Sniff
{
    ...
    protected function process_multi_line_array($stackPtr, $items, $opener, $closer)
    {
         ...
         */
        $index_end_cols = []; // Keep track of the end column position of index keys.
        $double_arrow_cols = []; // Keep track of arrow column position and count.
        $multi_line_count = 0;
