...
class PrefixAllGlobalsSniff extends AbstractFunctionParameterSniff
{
     ...
     * @var array
     */
    private $validated_namespace_prefixes = [];
     ...
     * @var array
     */
    protected $whitelisted_core_hooks = [
        'widget_title'   => true,
        'add_meta_boxes' => true,
    ];
     ...
     * @var array
     */
    protected $whitelisted_core_constants = [
    ...
    public function process_token($stackPtr)
    {
        ...
        $this->prefixes = $this->merge_custom_array($this->prefixes, [], false);
    ...
    protected function process_variable_variable($stackPtr)
    {
         ...
         */
        if ($this->phpcsFile->hasCondition($stackPtr, [\T_FUNCTION, \T_CLOSURE]) === true) {
    ...
    public function process_parameters($stackPtr, $group_name, $matched_content, $parameters)
    {
        ...
        if ('define' === $matched_content) {
            ...
            $data = ['Global constants defined'];
            $error_code = 'NonPrefixedConstantFound';
            if (false === $is_error) {
                $error_code = 'VariableConstantNameFound';
            }
        } else {
            $data = ['Hook names invoked'];
