...
class ValidVariableNameSniff extends PHPCS_AbstractVariableSniff
{
     ...
     * @var array
     */
    protected $wordpress_mixed_case_vars = [
        'EZSQL_ERROR'       => true,
     ...
     * @var array
     */
    protected $whitelisted_mixed_case_member_var_names = [
        'ID'                => true,
        'comment_ID'        => true,
     ...
     * @var string|string[]
     */
    public $customPropertiesWhitelist = [];
     ...
     * @var array
     */
    protected $addedCustomProperties = [
        'properties' => null,
    ];
    ...
    protected function mergeWhiteList()
    {
        if ($this->customPropertiesWhitelist !== $this->addedCustomProperties['properties']) {
            ...
            $customProperties = Sniff::merge_custom_array($this->customPropertiesWhitelist, [], false);
