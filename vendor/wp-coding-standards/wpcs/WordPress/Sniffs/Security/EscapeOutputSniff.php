...
class EscapeOutputSniff extends Sniff
{
     ...
     * @var string|string[]
     */
    public $customAutoEscapedFunctions = [];
     ...
     * @var string|string[]
     */
    public $customPrintingFunctions = [];
    ...
    public function process_token($stackPtr)
    {
        ...
        if (! isset($end_of_statement)) {
            $end_of_statement = $this->phpcsFile->findNext([\T_SEMICOLON, \T_CLOSE_TAG], $stackPtr);
