    ...
    public function process_token($stackPtr)
    {
        ...
        if (\T_DOUBLE_QUOTED_STRING === $this->tokens[$stackPtr]['code']
            ...
            foreach (array_intersect($interpolated_variables, $superglobals) as $bad_variable) {
                $this->phpcsFile->addError('Detected usage of a non-sanitized, non-validated input variable %s: %s', $stackPtr, 'InputNotValidatedNotSanitized', [$bad_variable, $this->tokens[$stackPtr]['content']]);
            }
