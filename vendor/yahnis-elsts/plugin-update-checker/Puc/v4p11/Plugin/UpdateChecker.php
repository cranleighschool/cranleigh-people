...
if (! class_exists('Puc_v4p11_Plugin_UpdateChecker', false)) {
    ...
    class Puc_v4p11_Plugin_UpdateChecker extends Puc_v4p11_UpdateChecker
    {
        ...
        {
            $scheduler = new Puc_v4p11_Scheduler($this, $checkPeriod, ['load-plugins.php']);
        ...
        {
            [$pluginInfo, $result] = $this->requestMetadata('Puc_v4p11_Plugin_Info', 'request_info', $queryArgs);
